...
//    "monomorphizeGenericClass",
  ...
  def collectPassesForSilver: Seq[AbstractPass] = {
    //TODO OS trying out whether flatten_generic_classes shoudl work like this.
    report = Passes.BY_KEY("monomorphizeGenericClass").apply_pass(report, Array())
